            ...
            <div className='relative hidden md:block'>
                <form
                    ...
                    <input type="text"
                        ...
                        className='bg-primary p-3 md:text-md font-medium border-gray-100 border-2 focus:outline-none focus:boder-2 focus:border-gray-300 w-[300px] md:w-[350px] rounded-full md:top-0 '
                    />
